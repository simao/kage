...
import kage.exception.EncryptionException
import kage.exception.IncorrectCipherTextException
...
public object Primitives {
    ...
    public fun aeadEncrypt(key: ByteArray, plainText: ByteArray): ByteArray {
        ...
        return cipher.doFinal(plainText) ?: throw EncryptionException("Failed to encrypt data, returned ByteArray was null")
    }
    ...
    public fun aeadDecrypt(key: ByteArray, size: Int, cipherText: ByteArray): ByteArray {
        ...
        if (cipherText.size != size + TAG_LENGTH) throw IncorrectCipherTextException("Encrypted value has unexpected length")

        cipher.init(Cipher.DECRYPT_MODE, secretKey, parameterSpec)
        return cipher.doFinal(cipherText) ?: throw EncryptionException("Failed to decrypt data, returned ByteArray was null")
    }
